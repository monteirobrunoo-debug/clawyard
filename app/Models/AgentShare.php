...
class AgentShare extends Model
{
    ...
    public static function agentMeta(): array
    {
        $overrides = [
            ...
            'hr'           => ['name' => 'Dr.ª Ana Sobral RH', 'emoji' => '👥', 'color' => '#ec4899', 'photo' => '/images/agents/hr.png'],
            'marketing'    => ['name' => 'Ana Monteiro Marketing', 'emoji' => '🎨', 'color' => '#f97316', 'photo' => '/images/agents/marketing.png'],
