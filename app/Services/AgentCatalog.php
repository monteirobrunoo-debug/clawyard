    ...
    public static function starters(string $key): array
    {
        $starters = [
            ...
            'hr'        => [
                ...
                '📋 Template completo avaliação de desempenho trimestral PartYard — escalas 1-5, competências core, formato SBI feedback',
                '🎓 Plano de formação 2026 por colaborador — 40h/ano obrigatórias, identificar acções DGERT prioritárias',
                '📅 Calendário de obrigações RH 2026 — DMR, IES, Relatório Único, GEP, Modelo 1 SS, mapa de férias',
                '⚖️ Cálculo subsídio de férias para contrato a termo certo — exemplo prático CCT comércio',
                '👤 Carta de admissão modelo CCT 17/2018 — categoria profissional + período experimental',
                '🎯 Definir OKRs Q1 2026 para o Departamento Comercial (Bruno e Daniel Jordão)',
                '💼 Plano de sucessão para funções críticas — quem substitui o Luís Gomes (CFO)?',
                '📊 Análise de turnover PartYard últimos 12 meses — comparação por departamento',
                '🚨 Banco de horas — limites legais e como compensar horas suplementares no fecho de Q1',
            ],
