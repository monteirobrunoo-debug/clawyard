...
class ResearchAgent implements AgentInterface
{
    ...
    protected string $contextKey  = 'competitive_intel';
    protected array  $contextTags = ['concorrente','competitor','mercado','market','benchmark','pricing','análise','empresa'];
...
SPECIALTY;
    ...
    public function stream(string|array $message, array $history, callable $onChunk, ?callable $heartbeat = null): string
    {
        ...
        $full = $this->streamAnthropicWithRetries(
            ...
            onChunk:          $onChunk,
            heartbeat:        $heartbeat,
            heartbeatLabel:   'analysing',
            heartbeatEvery:   10,
            retries:          [0, 2, 5],
            emergencyMessage: "⚠️ Marina (research) temporariamente indisponível. Tenta novamente em 30s.",
