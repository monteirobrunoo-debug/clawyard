...
class NvidiaController extends Controller
{
    ...
    public function chat(Request $request): JsonResponse
    {
        $request->validate([
            ...
            'agent'      => 'nullable|string|in:auto,orchestrator,nvidia,claude,sales,support,email,sap,document,maritime,cyber,aria,quantum,finance,research,capitao,acingov,engineer,patent,energy,kyber,qnap,thinking,batch,computer',
