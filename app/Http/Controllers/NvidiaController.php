...
class NvidiaController extends Controller
{
    ...
    public function chatStream(Request $request): StreamedResponse
    {
        ...
        $request->validate([
            ...
            'agent'     => 'nullable|string|in:auto,orchestrator,nvidia,claude,sales,support,email,sap,crm,document,maritime,cyber,aria,quantum,finance,research,capitao,acingov,engineer,patent,energy,kyber,qnap,thinking,batch,computer,vessel,mildef,shipping,briefing',
            'session_id'=> 'nullable|string|max:64|regex:/^[a-zA-Z0-9_\-]+$/',
