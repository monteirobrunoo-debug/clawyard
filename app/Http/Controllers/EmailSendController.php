...
class EmailSendController extends Controller
{
    ...
    /**
     * Render the (markdown) email body to branded, Outlook-safe HTML.
     *
     * Fase 2: delega no helper único App\Support\EmailHtml — markdown→HTML +
     * CSS inline (Outlook) + template de marca ClawYard (layout em tabela).
     */
    protected function wrapHtml(string $body, string $subject): string
    {
        return EmailHtml::render($body, $subject);
    }
}
