...
<div class="doc-top">
    <div class="company-block">
        <div class="company">PartYard · HP-Group · ClawYard Intelligence Platform</div>
...
<div class="doc-footer">
    ...
    <span>Gerado automaticamente por ClawYard AI · {{ $report->created_at->format('d/m/Y H:i') }}</span>
</div>
